<?php
namespace Schmitzal\Way2Enjoy\Service;
 ...
 * @package Schmitzal\Way2Enjoy\Service
 */
class CompressImageService
{
    /**
    ...
    {
        $this->extConf = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf']['way2Enjoy']);
    ...
    {
        /** @var \Schmitzal\Way2Enjoy\Domain\Model\File $extbaseFileObject */
